...
class HTTPCache {
    ...
    fetch(input, init) {
        return __awaiter(this, void 0, void 0, function* () {
            const request = new apollo_server_env_1.Request(input, init);
            ...
            if (policy.satisfiesWithoutRevalidation(policyRequestFrom(request))) {
                ...
                return new apollo_server_env_1.Response(body, { status: policy._status, headers });
            }
            else {
                ...
                return this.storeResponseAndReturnClone(revalidationRequest, modified
                    ...
                    : new apollo_server_env_1.Response(body, {
